...
export const Hero = () => {
  ...
  return (
    <section className="w-full h-full bg-white dark:bg-gray-200 dark:text-white transition-colors pl-[10%] pr-20 py-24 sm:py-36 text-gray-200 ">
      <h1 className="text-2xl leading-[35px] sm:text-5xl sm:leading-[70px] font-medium  mb-16">
        {TextContent.CompanyMission}
      </h1>
      <h2 className="text-gray-200 dark:text-white text-m sm:text-2xl mb-8 font-serif">
